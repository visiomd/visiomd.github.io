...
$(document).ready(function(){
	...
	$(window).load(function() {
		...
		$('#myTab2').tab('show');$('#myTab1').tab('show');
	}); 
	...
	$("#bt_next").on("click","a", function (event) {
...
$(window).on('load resize', function(){
	$('#slides_background_home').height = $('#home').height;
    $('#slides_background_home').height($('#slides_background_home').height());
});